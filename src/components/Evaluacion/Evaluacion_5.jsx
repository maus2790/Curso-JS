    ...
    const preguntas = [
        {
            ...
            pregunta: '¿Cuál de las siguientes NO es una característica de las funciones flecha (arrow functions)?',
            opciones: [
                'Sintaxis más corta',
            ...
            respuestaCorrecta: 1,
            explicacion: 'Las arrow functions NO tienen su propio this; heredan el this del contexto exterior.',
            dificultad: 'facil'
        },
        {
            id: 2,
...
console.log(sumar(3, 4));`,
            opciones: ['7', 'undefined', '34', 'Error'],
            respuestaCorrecta: 0,
            explicacion: 'La arrow function con return implícito devuelve la suma de 3 + 4 = 7.',
            dificultad: 'facil'
        },
        {
            id: 3,
            tipo: 'verdadero-falso',
            pregunta: 'Las funciones declaradas (function declaration) sufren hoisting, por lo que pueden llamarse antes de ser declaradas.',
            opciones: ['Verdadero', 'Falso'],
            respuestaCorrecta: 0,
            explicacion: 'Las function declarations son elevadas completamente (hoisting) y pueden usarse antes de su declaración.',
            dificultad: 'facil'
        },
        {
            id: 4,
            ...
            explicacion: 'La palabra clave "return" especifica el valor que la función devuelve al código que la llamó.',
            dificultad: 'facil'
        },
        {
            id: 5,
            ...
            respuestaCorrecta: 1,
            explicacion: 'Una closure es una función que tiene acceso a variables de su función exterior incluso después de que ésta haya terminado de ejecutarse.',
            dificultad: 'medio'
        },
        {
            id: 6,
            tipo: 'completar-codigo',
            pregunta: 'Completa el código para crear una función que devuelva el doble de un número:',
            codigo: `const duplicar = (n) => ___;`,
            espacios: 1,
            respuestasCorrectas: ['n * 2'],
            explicacion: 'La arrow function con return implícito devuelve n * 2.',
            dificultad: 'facil'
        },
        {
            id: 7,
...
console.log(miContador());`,
            opciones: ['0, 1', '1, 2', '1, 1', '0, 0'],
            respuestaCorrecta: 1,
            explicacion: 'La closure mantiene el estado de contador: primera llamada retorna 1, segunda retorna 2.',
            dificultad: 'medio'
        },
        {
            id: 8,
            tipo: 'verdadero-falso',
            pregunta: 'Los parámetros rest (...) deben ir al inicio de la lista de parámetros de una función.',
            opciones: ['Verdadero', 'Falso'],
            respuestaCorrecta: 1,
            explicacion: 'Los parámetros rest deben ser el último parámetro de la función, no el primero.',
            dificultad: 'facil'
        },
        {
            id: 9,
            tipo: 'texto-corto',
            pregunta: '¿Qué operador se usa para capturar múltiples argumentos como un array en una función?',
            respuestaCorrecta: '...',
            explicacion: 'El operador rest (...) se usa para capturar múltiples argumentos como un array.',
            dificultad: 'facil'
        },
        {
            id: 10,
            tipo: 'opcion-multiple',
            pregunta: '¿Cuál es la sintaxis correcta de una función de orden superior?',
            opciones: [
                'Una función que solo usa números',
                'Una función que recibe o retorna otra función',
                'Una función que no tiene parámetros',
                'Una función que solo usa strings'
            ],
            respuestaCorrecta: 1,
            explicacion: 'Las funciones de orden superior son aquellas que reciben funciones como argumentos o retornan funciones.',
            dificultad: 'facil'
        }
    ];
            ...
            <div className="evaluacion-contenido resultados-modo">
                <div className="pantalla-resultados">
                    ...
                    <div className="puntaje-final">
                        ...
                        {puntaje >= 70 ? <div className="mensaje-exito">¡Excelente trabajo! Dominas las funciones en JavaScript 🎉</div> : puntaje >= 50 ? <div className="mensaje-regular">Buen intento, practica más las funciones 👍</div> : <div className="mensaje-bajo">Revisa el material de "Funciones en JavaScript" y vuelve a intentarlo 💪</div>}
                    </div>
        ...
        <div className="evaluacion-contenido">
            <header className="evaluacion-header">
                <div className="encabezado-principal">
                    <h1>📝 Evaluación: Funciones en JavaScript</h1>
